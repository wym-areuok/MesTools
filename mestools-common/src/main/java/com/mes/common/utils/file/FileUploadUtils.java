package com.mes.common.utils.file;
...
import com.mes.common.exception.file.FileNameLengthLimitExceededException;
import com.mes.common.exception.file.FileSizeLimitExceededException;
import com.mes.common.exception.file.InvalidExtensionException;
import com.mes.common.utils.DateUtils;
import com.mes.common.utils.StringUtils;
import com.mes.common.utils.uuid.IdUtils;
import com.mes.common.utils.uuid.Seq;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = MesToolsConfig.getProfile();
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = MesToolsConfig.getProfile().length() + 1;
